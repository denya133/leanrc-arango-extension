...
(function() {
  ...
  module.exports = function(Module) {
    ...
    ({AnyT, FuncG, SubsetG, MaybeG, RecordInterface, Serializer, Mixin} = Module.prototype);
    return Module.defineMixin(Mixin('ArangoSerializerMixin', function(BaseClass = Serializer) {
      return (function() {
        var _Class;
